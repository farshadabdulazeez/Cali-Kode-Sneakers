# Generated by Django 4.2.5 on 2023-10-11 04:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Order confirmed', 'Order confirmed')], default='Order confirmed', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product_app.productvariant')),
            ],
        ),
        migrations.AddField(
            model_name='order',
